...
module.exports = function(passport) {
  ...
  const callbackURL = (process.env.NODE_ENV == 'production')?
    'https://mysterious-headland-16415.herokuapp.com/auth/facebook/callback' :
    'http://localhost300/auth/facebook/callback';
  passport.use(new FacebookStrategy({
    // 이 부분을 여러분 Facebook App의 정보로 수정해야 합니다.
    clientID : process.env.FBID || '185081248729582',
    clientSecret : process.env.FB_SCRET || 'f02d8be90007cf67bd16495033e1b95a',
